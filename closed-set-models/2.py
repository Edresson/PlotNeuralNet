...
arch = [
    ...
    to_Pool("maxpool1",zlabel='MaxPool 1x5', offset="(2,0,0)",width=1, height=15, depth=25, caption=""),
    to_connection("conv1","maxpool1"),


    to_Conv("conv2", "7x7", 16, offset="(4,0,0)", to="(0,0,0)",width=1, height=15, depth=25, caption="Conv CReLU" ),
    ...
    to_Conv("conv3", "7x7", 8, offset="(8,0,0)", to="(0,0,0)",width=1, height=7, depth=25, caption="Conv CReLU" ),
