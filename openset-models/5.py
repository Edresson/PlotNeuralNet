...
arch = [
    ...
    to_cor(),
    to_begin(),
    to_input( '../images/concatenacao-dos-embeddings.pdf',width=10, height=4,to='(0,2.2,0)' ),
    ...
    to_Dense("dense2", 8 ,offset="(5,0,0)", caption="FC CReLU",depth=60,Color ="\FcCreluColor" ),
    to_connection("dense1","dense2"),
    #to_SoftMax("soft2", 10 ,"(5,0,0)", caption="SoftMax"  ),
    to_Dense("dense3", 2 ,offset="(7,0,0)", caption="FC SoftMax",Color ="\FcSoftmaxColor",depth=30 ),
